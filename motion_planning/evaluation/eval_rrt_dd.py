...
from motion_planning.baseline.tsa_dd import RRT_plan_dd
from neural_cbf.training.utils import current_git_hash

# dynamic domain
def eval_rrt_dd(seed, environment, robot, obs_positions, obs_sizes, start_configs, end_configs, **kwargs):
    ...
    for idx in pbar:
        ...
        solutions.append(RRT_plan_dd(env=environment, init_state=init_state, goal_state=goal_state,
