...
def eval_batchrrt_vanilla(seed, environment, robot, obs_positions, obs_sizes, start_configs, end_configs, **kwargs):
	...
	for idx in pbar:
		...
		solutions.append(batch_RRT_plan(env=environment, init_state=init_state, goal_state=goal_state,
										...
										T=kwargs['max_node'], stop_when_success=True, batch=10))
